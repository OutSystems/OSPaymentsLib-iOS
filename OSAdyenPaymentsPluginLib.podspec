Pod::Spec.new do |s|
  s.name             = 'OSAdyenPaymentsPluginLib'
  s.version          = '1.1.0'
  ...
  s.source_files = 'OSPaymentsLib/Error/*.swift', 'OSPaymentsLib/Extensions/*.swift', 'OSPaymentsLib/Gateway/Protocols/*.swift', 'OSPaymentsLib/Gateway/Enums/*.swift', 'OSPaymentsLib/Gateway/FactoryMethod/*.swift', 'OSPaymentsLib/Gateway/*Adyen*.swift', 'OSPaymentsLib/Models/*.swift', 'OSPaymentsLib/Protocols/*.swift', 'OSPaymentsLib/*.swift' 
  s.pod_target_xcconfig = { 
    'SWIFT_ACTIVE_COMPILATION_CONDITIONS' => 'ADYEN_ENABLED'
  }
end